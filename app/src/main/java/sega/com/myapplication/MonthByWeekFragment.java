...
import sega.com.myapplication.CalendarController.EventInfo;
import sega.com.myapplication.CalendarController.EventType;
import sega.com.myapplication.CalendarController.ViewType;
...
/*    private CreateEventDialogFragment mEventDialog;*/
    ...
    protected void setUpAdapter() {
        ...
        System.out.println(mNumWeeks);
        System.out.println(mShowWeekNumber);
        System.out.println(mFirstDayOfWeek);
        System.out.println(mIsMiniMonth);
        System.out.println(Time.getJulianDay(mSelectedDay.toMillis(true), mSelectedDay.gmtoff));
        System.out.println(mDaysPerWeek);
    ...
    public android.support.v4.content.Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        synchronized (mUpdateLoader) {
            ...
            System.out.println(mEventUri.getHost());
...
//
            Event i = events.get(0);

//            Event i2 = events.get(3);
            Log.d("aaaaa", "id: "+i.id+" title: "+i.title+" color: "+i.color+" location: "+i.location+" allday: "+i.allDay+" startday: "+i.startDay
                    +" endday: "+i.endDay+" startmilis: "+i.startMillis+" endMilis: "+i.endMillis+" hasAlarm: "+i.hasAlarm+" osReperting: "+i.isRepeating
                    +" selfAttendeeStatus: "+i.selfAttendeeStatus);
            Event i2 = new Event();


            Calendar calendar = Calendar.getInstance();
            String c = calendar.HOUR_OF_DAY+"";
            Log.d("bbbbb", "onLoadFinished: "+c);
            long a = Long.parseLong("1487650676736");
            long b = Long.parseLong("1487823476736");
            Time timee = new Time();
            timee.setToNow();
            long currentTime = System.currentTimeMillis();
            int julianDay = Time.getJulianDay(a, timee.gmtoff);
            int currentJulianDay = Time.getJulianDay(b, timee.gmtoff);

            i2.setId(128);
            i2.setTitle("an lol");
            i2.setColor(-11622632);
            i2.setLocation("viet han");
            i2.setAllDay(true);

            i2.setStartMillis(a);
            i2.setEndMillis(b);
            i2.setHasAlarm(false);
            i2.setRepeating(false);
            i2.setSelfAttendeeStatus(0);
            i2.setStartDay(julianDay);
            i2.setEndDay(currentJulianDay);

            System.out.println(i2.id);
            System.out.println(i2.title);
            System.out.println(i2.color);
            System.out.println(i2.location);
            System.out.println(i2.allDay);
            System.out.println(i2.startDay);
            System.out.println(i2.endDay);
            System.out.println(i2.startMillis);
            System.out.println(i2.endMillis);
            System.out.println(i2.hasAlarm);
            System.out.println(i2.isRepeating);
            System.out.println(i2.selfAttendeeStatus);

            long aa = Long.parseLong("1487649168335");
            long bb = Long.parseLong("1487649168335");
            Time timeee = new Time();
            timeee.setToNow();
            long currentTimee = System.currentTimeMillis();
            int julianDaye = Time.getJulianDay(aa, timeee.gmtoff);
            int currentJulianDaye = Time.getJulianDay(bb, timeee.gmtoff);

            Event i3 = new Event();
            i3.setId(128);
            i3.setTitle("an lol");
            i3.setColor(-11622632);
            i3.setLocation("viet han");
            i3.setAllDay(false);

            i3.setStartMillis(aa);
            i3.setEndMillis(bb);
            i3.setHasAlarm(false);
            i3.setRepeating(false);
            i3.setSelfAttendeeStatus(0);
            i3.setStartDay(julianDaye);
            i3.setEndDay(currentJulianDaye);
         ...
         /*   events2.add(events.get(1));*/
        /*    events2.add(events.get(2));*/
//            events2.add(events.get(3));
//            events2.add(events.get(4));
           /* events2.add(events.get(5));*/
//            System.out.println(i2.id);
//            System.out.println(i2.title);
//            System.out.println(i2.color);
//            System.out.println(i2.location);
...
//            System.out.println(i2.selfAttendeeStatus);
            ...
            ((MonthByWeekAdapter) mAdapter).setEvents(mFirstLoadedJulianDay,
                    mLastLoadedJulianDay - mFirstLoadedJulianDay + 1, events2);
        }
    }
